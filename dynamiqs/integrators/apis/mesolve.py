...
def mesolve(
    ...
    *,
    ...
    return f(H, Ls, rho0, tsave, exp_ops, method, gradient, options, truncation_error)
...
def _vectorized_mesolve(
    ...
    if options.cartesian_batching:
        ...
        f = multi_vmap(_mesolve, in_axes, out_axes, len(bshape))
...
def _mesolve(
    ...
    if isinstance(H, tuple):
        H, H_extended = H
        Ls, Ls_extended = [L for L, _ in Ls], [Le for _, Le in Ls]
        extended = {'H_extended': H_extended, 'Ls_extended': Ls_extended}
